package app.ssnc.oasis.handler.firewall.controller
...
import app.ssnc.oasis.handler.firewall.service.FirewallService
...
class FirewallController : ResponseEntityExceptionHandler() {
    ...
    @PostMapping("/apporoval/fpms/{id}")
    fun registerRuleFPMS(@PathVariable id: Long) : ResultResponse {
        return ResultResponse.success(firewallService.registerRuleFPMS(id))
    }
}