package app.ssnc.oasis.security.config

import app.ssnc.oasis.config.ApiConfig.API_PATH
import app.ssnc.oasis.config.ApiConfig.API_VERSION
import app.ssnc.oasis.config.ApiConfig.AUTH_PATH
import app.ssnc.oasis.config.SecurityConfig.PASSWORD_STRENGTH
import app.ssnc.oasis.security.CustomUserDetails
import app.ssnc.oasis.security.jwt.JwtAuthenticationFilter
import app.ssnc.oasis.security.jwt.JwtTokenProvider
...
//    }
    ...
    override fun configure(http: HttpSecurity): Unit = with(http) {
        ...
        authorizeRequests()
            ...
            .antMatchers("/$API_PATH/$API_VERSION/user").permitAll()
