package app.ssnc.oasis.entity.request

import app.ssnc.oasis.entity.model.enum.*
...
data class CreateEmployeeRequest (
    ...
    @NotNull val usernmae: String,
    @Enumerated(EnumType.STRING) val status: EmployeeStatus? = null,
    @NotNull val mobile: String,
    val tel: String? = null,
    val joinDate: LocalDate? = null,
    @Enumerated(EnumType.STRING) val position: EmployeePosition? = null,
    @Enumerated(EnumType.STRING) val sex: Gender? = null,
//    val deptId: Long
